...
const MonthlyProfit = () => {
  ...
  const fetchMonthlyExpenses = async () => {
    try {
      const response = await fetch(`${import.meta.env.REACT_APP_API_URL}/api/payment/current-month`);
  ...
  const fetchMonthlySalary = async () => {
    try {
      const response = await fetch(`${import.meta.env.REACT_APP_API_URL}/api/salary/getTotalGrossPaymentForCurrentMonth`);
  ...
  const fetchTotalEventBudgeforMonth = async () => {
    try {
      const response = await fetch(`${import.meta.env.REACT_APP_API_URL}/api/events/monthly-total-budget`);
  ...
  const fetchTotalInventoryPurchasesForMonth = async () => {
    try {
      const response = await fetch(`${import.meta.env.REACT_APP_API_URL}/api/inventory/total-price/month`);
  ...
  const fetchMonthlySalesRevenue = async () => {
    try {
      const response = await fetch(`${import.meta.env.REACT_APP_API_URL}/api/orders/monthly-sales-revenue`);
  ...
  const fetchEventRevenue = async () => {
    try {
      const response = await fetch(`${import.meta.env.REACT_APP_API_URL}/api/events/monthly-total-revenue`);
  ...
  const fetchPreviousMonthData = async () => {
    try {
      const response = await fetch(`${import.meta.env.REACT_APP_API_URL}/api/income/previous-month/${previousMonth}`);
  ...
  const sendReportDataToBackend = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.REACT_APP_API_URL}/api/income/save-monthly`, {
        method: 'POST',
        headers: {
