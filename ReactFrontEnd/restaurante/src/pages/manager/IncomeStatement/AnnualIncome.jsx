...
const AnnualIncome = () => {
  ...
  const fetchAnnualExpenses = async () => {
    try {
      const response = await fetch(`localhost:8080/api/payment/current-year`);
      if (!response.ok) {
  ...
  const fetchAnnualSalary = async () => {
    try {
      const response = await fetch(`localhost:8080/api/salary/getTotalGrossPaymentForCurrentYear`);
      if (!response.ok) {
  ...
  const fetchTotalEventBudgetforYear = async () => {
    try {
      const response = await fetch(`localhost:8080/api/events/annual-total-budget`);
      if (!response.ok) {
  ...
  const fetchTotalInventoryPurchasesForYear = async () => {
    try {
      const response = await fetch(`localhost:8080/api/inventory/total-price/year`);
      if (!response.ok) {
  ...
  const fetchAnnualSalesRevenue = async () => {
    try {
      const response = await fetch(`localhost:8080/api/orders/annaul-sales-revenue`);
      if (!response.ok) {
  ...
  const fetchEventRevenue = async () => {
    try {
      const response = await fetch(`localhost:8080/api/events/annual-total-revenue`);
      if (!response.ok) {
  ...
  const fetchPreviousYearData = async () => {
    try {
      const response = await fetch(`localhost:8080/api/income/previous-year/${previousYear}`);
      if (!response.ok) {
  ...
  const sendReportDataToBackend = async () => {
    try {
      ...
      const response = await fetch(`localhost:8080/api/income/save-annual`, {
        method: 'POST',
        headers: {
