...
export default function OrderView() {
    ...
    useEffect(() => {
        ...
        if (!orderIDFromUrl) {
            ...
            Swal.fire({
                ...
                navigate("/waiter?tab=manage-orders");
            });
            return;
        }
    ...
    const handleEditOrder = () => {
        if (OrderResponse.orderId) {
            navigate(`/waiter?tab=update-orders&order=${OrderResponse.orderId}`);
        }
    };
    ...
    const handleBack = () => {
        Swal.fire({
            title: '¿Estás seguro?',
            text: '¿Quieres regresar al listado?',
            icon: 'warning',
    ...
    return (
        <div className="w-full bg-slate-200 dark:bg-slate-500 py-5 min-h-screen">
                        ...
                        <div className="py-2 flex flex-col justify-between rounded-lg border bg-white mb-6 shadow-md dark:bg-gray-600 dark:border-none min-h-[calc(100vh-21rem)] h-auto">
                            ...
                            <div className="px-4 md:px-6 py-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <div>
                                        <p className="mb-1 text-sm md:text-md">S/. {(subtotal * (discountPercentage / 100)).toFixed(2)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col md:flex-row w-full justify-evenly my-2">
                                    ...
                                    <div className="w-full md:w-1/2 md:ml-2">
                                        ...
                                        <textarea
                                            ...
                                            className="appearance-none block w-full bg-gray-200 text-gray-500 cursor-not-allowed rounded py-2 px-4 mb-3 border border-gray-300 focus:outline-none focus:ring-0 dark:bg-gray-700 dark:text-gray-400 dark:border-gray-600"
                                            readOnly
                                            value={note || "Sin notas especiales"}
                                        />
                                    </div>
                                </div>
