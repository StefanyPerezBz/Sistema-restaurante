...
function ResetPassword() {
    ...
    const handleSubmitUsername = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`localhost:8080/reset-password-request`, { username });
    ...
    const handleSubmitOtp = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`localhost:8080/verify-otp`, { 
                username,
                otp 
            });
    ...
    const handleSubmitPassword = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`localhost:8080/reset-password`, {
                username,
                newPassword,
                confirmPassword
            });
