...
function ResetPassword() {
    ...
    const handleSubmitUsername = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`${import.meta.env.REACT_APP_API_URL}/reset-password-request`, { username });
    ...
    const handleSubmitOtp = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`${import.meta.env.REACT_APP_API_URL}/verify-otp`, { 
                username,
                otp 
            });
    ...
    const handleSubmitPassword = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`${import.meta.env.REACT_APP_API_URL}/reset-password`, {
                username,
                newPassword,
                confirmPassword
            });
