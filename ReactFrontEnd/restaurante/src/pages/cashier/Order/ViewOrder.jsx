...
export const ViewOrder = () => {
    ...
    useEffect(() => {
        ...
        const fetchOrderDetails = async () => {
            try {
                const response = await axios.get(`${import.meta.env.REACT_APP_API_URL}/api/orders/${orderIDFromUrl}`);
                ...
                if (response.status === 200) {
                    ...
                    if (customer) {
                        ...
                        // Solo aplicar descuento de 5% si no hay descuento definido
    ...
    useEffect(() => {
        // Recalcular solo si hay cambios en los items o descuento
    ...
    const handleProcessOrder = () => {
        navigate(`/cashier?tab=bill&order=${OrderResponse.orderId}`);
    };

    if (loading) {
        return (
            <div className="w-full bg-slate-200 dark:bg-slate-500 py-5 flex justify-center items-center h-screen">
    ...
    return (
        <div className="w-full bg-slate-200 dark:bg-slate-500 py-5 rounded-lg shadow min-h-screen">
                                ...
                                <div className='flex flex-col md:flex-row items-center justify-between w-full overflow-hidden gap-2 mt-4'>
                                    ...
                                    {OrderResponse.orderStatus === "Ready" && (
                                        <button
                                            ...
                                            className="w-full md:w-auto flex-grow flex items-center justify-center px-3 py-2 bg-green-500 text-white font-semibold rounded hover:bg-green-600"
                                        >
                                            <span className="mr-1">Procesar orden</span>
