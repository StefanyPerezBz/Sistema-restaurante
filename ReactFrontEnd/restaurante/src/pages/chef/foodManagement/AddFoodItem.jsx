...
export function AddFoodItem({ onClose }) {
    ...
    const handleAddFood = async () => {
        ...
        try {
            const response = await axios.post(`localhost:8080/api/food/add`, addItem);
            ...
            try {
                await axios.post(
                    `localhost:8080/api/food/upload-image/${response.data.foodId}`,
                    formData,
                    {
                        headers: {
                ...
                await axios.delete(`localhost:8080/api/food/delete/${response.data.foodId}`);
                Swal.fire({
                    title: 'Error',
