...
//             {/* Finish Orders */}
//             <Label className='text-2xl font-bold m-5'>Pedidos finalizados</Label>
...
export default function FinishedOrders() {
    ...
    useEffect(() => {
        // Filter orders to only show Ready status
        const finishedOrders = orders.filter(order => order.orderStatus === 'Ready');
    ...
    return (
        <div className='w-full min-h-screen bg-gray-100 p-4'>
                ...
                <Navbar fluid rounded>
                    <Navbar.Collapse className="flex flex-wrap justify-center md:justify-start">
                        ...
                        <Link to="/chef?tab=finishedOrders" className="m-1">
                            <Button color="success" pill active>
                                Terminados: {filteredOrders.length}
                            </Button>
                        </Link>
            ...
            <Label className='text-2xl font-bold mb-4'>Pedidos finalizados - {new Date().toLocaleDateString()}</Label>
                ...
                <div className="bg-white shadow-md rounded-2xl p-4 overflow-x-auto">
                    {filteredOrders.length === 0 ? (
                        ...
                        <DataTable
                            ...
                            responsive
                            highlightOnHover
                            noDataComponent={<div className="py-4">No hay pedidos finalizados</div>}
                        />
                    )}
                </div>
            ) : (
