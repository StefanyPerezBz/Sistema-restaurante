...
//     pdf.save('Reporte Anual.pdf'); // Save PDF with filename
//   });
...
//                 <Table.Cell className='bg-orange-600 text-white font-semibold text-right' >S/.</Table.Cell>
//               </Table.Row>
//               <Table.Row className="bg-white text-black dark:text-white dark:border-gray-700 dark:bg-gray-800">
...
//                 <Table.Cell className='bg-orange-600 text-white'>GANANCIA / PÉRDIDA NETA</Table.Cell>
//                 <Table.Cell className='bg-orange-600 text-white'></Table.Cell>
...
const AnnualIncome = () => {
  ...
  const fetchAnnualSalesRevenue = async () => {
    try {
      const response = await fetch('http://localhost:8080/api/orders/annual-sales-revenue');
      if (!response.ok) {
        ...
        <div className="inline-block border w-full">
          ...
          <Table hoverable className='w-full'>
            <Table.Body className='divide-y'>
              ...
              <Table.Row className="bg-white text-black dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                <Table.Cell>Presupuesto de eventos</Table.Cell>
                <Table.Cell className='pr-2 text-right'>{formatCurrency(totalEventBudgetforYear)}</Table.Cell>
                <Table.Cell></Table.Cell>
              </Table.Row>
              <Table.Row className="bg-white text-black dark:border-gray-700 dark:bg-gray-800 dark:text-white">
