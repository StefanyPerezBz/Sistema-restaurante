...
export default function TakeOrder() {
        ...
        const generateOrder = async () => {
            ...
            const orderJSON = {
                ...
                orderDateTime: new Date(new Date().toLocaleString('en-US', { timeZone: 'America/Lima' })).toISOString(),
                orderStatus: "Pending",
            ...
            try {
                ...
                if (tableNumber > 0) {
                    try {
                        ...
                        toast.error("Se produjo un error al realizar el pedido. La mesa está disponible de nuevo..", { duration: 6000 });
                    } catch (updateError) {
                        console.error("Error al actualizar la disponibilidad de la mesa:", updateError);
                        toast.error("Se ha producido un error. Inténtalo de nuevo..", { duration: 6000 });
                    }
                }
            }
            finally{
                            ...
                            <div className="px-6 py-3">
                                ...
                                <div className=" w-full justify-evenly">
                                    <div className="w-full mb-2">
                                        <label htmlFor="table"  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Mesa :</label>
                                        <select
                                            id="table"
                                            value={tableNumber}
